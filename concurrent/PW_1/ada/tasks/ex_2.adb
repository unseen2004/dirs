...
procedure Ex_2 is  -- Changed procedure name to match filename
...
-- Timing
  -- FIXED: Qualified the Time type with Ada.Real_Time
...
-- Types, procedures and functions
  ...
  task body Traveler_Task_Type is
    ...
    begin
      ...
      loop
        ...
        -- FIXED: Use a more appropriate way to check elapsed time
        declare
          Current_Time : Ada.Calendar.Time := Ada.Calendar.Clock;
          Elapsed : Duration;
        begin
          -- Convert to Duration using Ada.Calendar."-" function
  ...
  begin
    accept Init(Id: Integer; Seed: Integer; Symbol: Character) do
      ...
      -- FIXED: Qualified Clock with Ada.Real_Time
      Time_Stamp := To_Duration(Ada.Real_Time.Clock - Start_Time); -- reads global clock
    end Init;
...
end Ex_2;  -- Changed end statement to match procedure name
