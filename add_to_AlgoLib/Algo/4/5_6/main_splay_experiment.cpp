...
int main() {
    ...
    std::ofstream ofs_inc("results_increasing_splay.csv");
    std::ofstream ofs_rand("results_random_splay.csv");
    ...
    for (int n : ns) {
        ...
        // Case A: insert 1..n in increasing order, then delete random
    ...
    ofs_inc.close();
    ofs_rand.close();
    std::cout << "Splay Experiment data written to results_increasing_splay.csv and results_random_splay.csv\n";
    return 0;
}
